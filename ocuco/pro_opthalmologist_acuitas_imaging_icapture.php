            ...
            <td width="685" valign="top"><!-- InstanceBeginEditable name="content_area" -->
              ...
              <table width="685" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td height="21" background="images/line_bg.jpg" ><img src="images/capturing_image.gif" width="124" height="20" /></td>
                ...
                <tr>
                  ...
                  <td class="text">Acquire images from Fundus &amp; Anterior cameras

                    <p>A list of compatible cameras is provided in the Appendix. Alternatively, contact Ocuco for compatibility details of<br /> 

                      unlisted cameras &amp; equipments)</p></td>

                </tr>

                <tr>

                  <td class="red_bullet">  <ul><li>Scan in, printed photographs & field charts, using a scanner.</li>



  <li>Import images in the following formats: BMP, JPEG, JPEG2000, TIFF, PhotoShop PSD, Popular Camera RAW format,<br /> 

    to name a few.</li>



 <li>Copy & Paste images from Windows clipboard, directly.</li></ul></td>
