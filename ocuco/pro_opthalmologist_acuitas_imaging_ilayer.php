            ...
            <td width="685" valign="top"><!-- InstanceBeginEditable name="content_area" -->
              ...
              <table width="685" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td height="21" background="images/line_bg.jpg" ><img src="images/viewing_image_layers.gif" width="157" height="20" /></td>
                ...
                <tr>
                  ...
                  <td height="8" class="red_bullet">

				  <ul><li>View images as layers that can be over laid on top of each other for comparing.

</li>



   <li>Build Fundus maps with suitably photographed images</li>



   <li>Build anaglyph stereo with suitably photographed images, which can give a feel for the depth when viewed with the<br /> 

     red-green glasses</li>



  <li>Adjust Opacity of individual layers</li>



   <li>Adjust transparency modes of individual layers</li>

   <li>Print of rendered Fundus maps</li>
