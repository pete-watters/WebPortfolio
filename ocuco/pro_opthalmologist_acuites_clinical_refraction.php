            ...
            <td width="685" valign="top"><!-- InstanceBeginEditable name="content_area" -->
              ...
              <table width="685" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td height="21" background="images/line_bg.jpg" ><img src="images/refraction.gif" width="70" height="20" /></td>
                ...
                <tr>
                  ...
                  <td class="text"><strong>Overview</strong> <br />

                    Ocuco have the most comprehensive recording of the refraction. Refractions recorded above those gathered in pre-test<br /> 

                    are Retinoscopy, Subjective and Rx Given. Where relevant there is distance, near and intermediate recorded with Adds,<br /> 

                    prisms, bases and PDs. It is important for the refraction area of clinical system:</td>

                </tr>

                <tr>

                  <td class="red_bullet" style="padding-top:4px; ">
...
<li>To integrate with other areas of the application such as NHS forms, dispensing etc</li>
                ...
                <tr>
                  ...
                  <td height="470" valign="top"><img src="images/Refraction_1.jpg" width="402" height="470" /></td>
	...
	<li>Links with consulting room equipment such as phoroptor head for both output and input</li>
	...
	<li>Special page for graph representation of Acuity, Sphere and Cyl for patients Subjective and Given prescriptions to<br /> 

	  aid in communications and interaction with Patient</li>
