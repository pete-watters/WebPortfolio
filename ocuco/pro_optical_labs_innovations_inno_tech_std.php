            ...
            <td width="685" valign="top"><!-- InstanceBeginEditable name="content_area" -->
              ...
              <table width="685" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td height="16" class="text"><p>Designed for surfacing labs performing calculations and managing the business</p></td>
...
<li>Machine interface to Gerber Coburn equipment with options for additional equipment interfaces </li>
...
<li>Gerber Coburn Machine Interfaces </li>
...
<ul style="padding-top:10px; "><li>Machine interfaces: LOH, Nidek, Optronics</li>

<li>Developer's Kit for order entry from other systems</li>
