            ...
            <td width="685" valign="top"><!-- InstanceBeginEditable name="content_area" -->
              ...
              <table width="685" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td height="21" background="images/line_bg.jpg" ><img src="images/acquitas_retail_enterprise_edition.jpg" width="219" height="20" /></td>
                ...
                <tr>
                  ...
                  <td class="text" >Acuitas Enterprise is the only Oracle-based world class distributed optical software solution. It is suitable for chains of optical<br /> 

                    stores of all sizes, and is available in many distribution models, and many financing options.

                    <p>If you have 2 stores or more, there is certainly an Acuitas Enterprise that suits your needs.<br />
