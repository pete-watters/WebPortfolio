            ...
            <td width="685" valign="top"><!-- InstanceBeginEditable name="content_area" -->
              ...
              <table width="685" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td height="21" background="images/line_bg.jpg" valign="top" ><img src="images/sage_accounts_integration.gif" width="181" height="20" /></td>
                ...
                <tr>
                  ...
                  <td class="text">Much of the data that Acuitas captures during everyday operation can be transferred into<br />

                    accounts systems such as Sage Accounts.

                  <p>This data includes, but is not limited to, sales analysis by product group; outstanding<br />debtors; banking; petty cash analysis and purchase invoices. In conjunction with your own<br />accountants, we can advise how best to set up the system and develop small utilities where<br />

                  necessary to ensure that your Acuitas data can be input directly into your accounts system<br />

                  with no re-keying necessary.</p>
