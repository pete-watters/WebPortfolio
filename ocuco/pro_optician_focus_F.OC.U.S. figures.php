            ...
            <td width="685" valign="top"><!-- InstanceBeginEditable name="content_area" -->
              ...
              <table width="685" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td height="21" background="images/line_bg.jpg" ><img src="images/focus_figures.gif" width="104" height="20" /></td>
                ...
                <tr>
                  ...
                  <td class="text">For companies with more than one branch, we can provide the F.O.C.U.S. Figures Data<br />

                    Warehouse &ndash; a unique SQL-Server based central database containing consolidated data from<br />

                    all the practices. Practice data can be downloaded automatically into the central database<br />

                    then used to provide reports consolidating data from all branches (e.g. sales figures and<br />

                    product sales), and also compare the performance between them.<br /></td>
