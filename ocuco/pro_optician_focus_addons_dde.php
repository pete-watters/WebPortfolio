...
<?php include("products_side_menu.php")?> 
            ...
            <td width="685" valign="top"><!-- InstanceBeginEditable name="content_area" -->
              <table width="685" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="21" background="images/line_bg.jpg" ><img src="images/ao_dd.gif" alt="Focus Add-On Direct Debit Module" width="286" height="20" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td class="text"> Takes Direct Debit requests from Focus directly
                  		into your BACS software.<br /> Before purchasing, contact Ocuco to verify that your BACS supplier is approved for use with this module:<br />                    <br />
