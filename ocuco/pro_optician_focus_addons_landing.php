...
<?php include("products_side_menu.php")?> 
            ...
            <td width="685" valign="top"><!-- InstanceBeginEditable name="content_area" -->
              <table width="685" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="21" background="images/line_bg.jpg" ><img src="images/add_ons.gif" width="63" height="20" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td class="text"><p><strong>More Focus<br />
                  </strong>                    Whichever version of Focus you have, Ocuco has developed specific software to add on to the configuration you already<br /> 
                  have, for the purpose of enhancing your utilisation of Focus within your practice.</p>
