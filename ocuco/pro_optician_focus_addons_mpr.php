...
<?php include("products_side_menu.php")?> 
            ...
            <td width="685" valign="top"><!-- InstanceBeginEditable name="content_area" -->
              <table width="685" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="21" background="images/line_bg.jpg" ><img src="images/ao_multiple.gif" alt="Focus Add-On Multiple Age and Multiple Branch Recall" width="286" height="20" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td class="text">Multiple Practice Recall is an add-on module for Focus Practice Management which allows Multiple
                  		Age Bands and  Multi Branch Recall:
			        <ul>
			          <li>Enables you to perform increased age band breakdown of Recall
			            Groups. </li>
			          <li>Allows recalls from multiple branches to be sent from a single
			            location.</li>
			          </ul>
		</tr>
                <tr>
