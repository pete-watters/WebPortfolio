            ...
            <td width="685" valign="top"><!-- InstanceBeginEditable name="content_area" -->
              ...
              <table width="685" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td height="21" background="images/line_bg.jpg" ><img src="images/ff_reports.gif" width="286" height="20" /></td>
...
<td  class="text" style="padding-top:5px;">The reports listed below are just a small selection of the reports provided as standard with Full Focus:<br />  <br /></td>
                ...
                <tr>
                  ...
                  <td class="red_bullet" style="padding-top:5px; "><ul>
                      ...
                      <li>Departmental sales analysis by week/date. </li>                      <li>Sales by date/sales type.</li>
                      ...
                      <li>Current frame stock and valuation </li>
