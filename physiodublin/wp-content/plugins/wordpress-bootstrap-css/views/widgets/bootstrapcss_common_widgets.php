	  ...
	  <div class="span12">
		  <div class="well">
			...
			<div class="row">
				...
				<div class="span5">
					<ul>
						<li><a href="http://bit.ly/IsHLL1" target="_blank"><strong>Read the plugin Help & Support page</strong></a>.</li>
