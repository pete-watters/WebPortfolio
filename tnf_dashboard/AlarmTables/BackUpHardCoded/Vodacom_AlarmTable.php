	...
	<body id="dt_example">
		<div id="container">
			<div class="full_width big">
				<center><i>Vodacom SA</i> Midas+ Alarm Monitor</center>
			</div>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="AlarmTable">
	...
	<tbody>
		...
		<tr class="gradeX">
			...
			<td>VCOM</td>
			<td>CRITICAL: Silverton is not producing log files</td>
		...
		<tr class="gradeC">
			...
			<td>VCOM</td>
			<td>WARNING: NIC Speed is below 80 Mb/s in Midrand2</td>
