...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="AlarmTable">
	...
	<tbody>
		<tr class="gradeA">
			...
			<td>VFIT</td>
			<td>OK: Milano3 has recovered from hardware failure</td>
		...
		<tr class="gradeX">
			...
			<td>VFIT</td>
			<td>CRITICAL: Milano1 is not producing log files</td>
		...
		<tr class="gradeC">
			...
			<td>VFIT</td>
			<td>WARNING: NIC Speed is below 80 Mb/s in Bologna</td>
