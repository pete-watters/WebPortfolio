	...
	<body id="dt_example">
		<div id="container">
			<div class="full_width big">
				<center><i> Vodafone Italy</i> Midas+ Alarm Monitor</center>
			</div>
			
			<div id="demo">
           <table cellpadding="0" cellspacing="0" border="0" class="display" id="AlarmTable_VFIT">
	               <thead>
		       <tr>
	       ...
	       <tbody>
                  ...
                  <?php
                   ...
                   // sending query
                 $result = mysql_query("SELECT severity, customer, host,alarm, dates, datem  FROM {$table} where customer LIKE \"%VFIT%\" AND RESOLVED != \"1\" ORDER BY severity, datem");
