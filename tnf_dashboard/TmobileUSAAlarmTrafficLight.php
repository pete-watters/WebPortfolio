...
// sending query
$AlarmCritical_resultSet = mysql_query("SELECT count(ID) as COUNT_CRITICAL_ALARMS from mail.alarms where customer LIKE '%TMUSA%' AND (SEVERITY = 'CRITICAL' || SEVERITY = 'DOWN') AND RESOLVED != 1");
