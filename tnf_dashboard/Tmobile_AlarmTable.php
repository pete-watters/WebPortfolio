	...
	<body id="dt_example">
		<div id="container">
			<div class="full_width big">
				<center><i>T-Mobile USA</i> Midas+ Alarm Monitor</center>
			</div>
	       ...
	       <tbody>
                  ...
                  <?php
                   ...
                   // sending query
                 $result = mysql_query("SELECT severity, customer, host,alarm, dates, datem  FROM {$table} where customer LIKE \"%TMUSA%\" AND RESOLVED != \"1\" ORDER BY severity, datem");
              ...
              while($row = mysql_fetch_row($result))
                ...
                elseif($row['severity'] == "DOWN" ){echo "<tr class=\"gradeX\">";}
