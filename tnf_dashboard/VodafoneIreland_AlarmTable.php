		...
		<div id="container">
	       ...
	       <tbody>
                  ...
                  <?php
                   ...
                   // sending query
                 $result = mysql_query("SELECT severity, customer, host,alarm, dates, datem  FROM {$table} where customer LIKE \"%VFIE%\" AND RESOLVED != \"1\" ORDER BY severity, datem");
	       ...
	       <tbody>
                  ...
                  <?php
                   ...
                   // sending query
                 $result = mysql_query("SELECT severity, customer, host,alarm, dates, datem  FROM {$table} where customer LIKE \"%VFIE%\"  ORDER BY severity DESC, datem DESC");
				 $result1 = mysql_query("SELECT severity, customer, host,alarm, dates, datem  FROM {$table2} where customer LIKE \"%VFIE%\"  ORDER BY severity DESC, datem DESC");
              ...
              while($row = mysql_fetch_row($result))
                {
              $row['severity'] == $rowseverity;
                if($rowseverity == "CRITICAL" ) {echo "<tr class=\"gradeX\">";}
                elseif($rowseverity == "WARNING" ){echo "<tr class=\"gradeC\">";}
                elseif($rowseverity == "OK" ){echo "<tr class=\"gradeA\">";}
                else {echo "<tr class=\"gradeX\">";}
